...
int main(void)
{
  ...
  while (1)
  {
    // LED 1 ON (Active-Low: RESET is ON)
    HAL_GPIO_WritePin(SYS_USER_LED1_GPIO_Port, SYS_USER_LED1_Pin, GPIO_PIN_RESET);
    HAL_Delay(200);
    HAL_GPIO_WritePin(SYS_USER_LED1_GPIO_Port, SYS_USER_LED1_Pin, GPIO_PIN_SET);

    // LED 2 ON
    HAL_GPIO_WritePin(SYS_USER_LED2_GPIO_Port, SYS_USER_LED2_Pin, GPIO_PIN_RESET);
    HAL_Delay(200);
    HAL_GPIO_WritePin(SYS_USER_LED2_GPIO_Port, SYS_USER_LED2_Pin, GPIO_PIN_SET);

    // LED 3 ON
    HAL_GPIO_WritePin(SYS_USER_LED3_GPIO_Port, SYS_USER_LED3_Pin, GPIO_PIN_RESET);
    HAL_Delay(200);
    HAL_GPIO_WritePin(SYS_USER_LED3_GPIO_Port, SYS_USER_LED3_Pin, GPIO_PIN_SET);

    // LED 4 ON
    HAL_GPIO_WritePin(SYS_USER_LED4_GPIO_Port, SYS_USER_LED4_Pin, GPIO_PIN_RESET);
    HAL_Delay(200);
    HAL_GPIO_WritePin(SYS_USER_LED4_GPIO_Port, SYS_USER_LED4_Pin, GPIO_PIN_SET);

    // Status LED ON
    HAL_GPIO_WritePin(SYS_STS_LED_GPIO_Port, SYS_STS_LED_Pin, GPIO_PIN_RESET);
    HAL_Delay(500);
    HAL_GPIO_WritePin(SYS_STS_LED_GPIO_Port, SYS_STS_LED_Pin, GPIO_PIN_SET);
